...
<?php 
		if(isset($_POST['approve_cust'])){
			...
			// $sender = 'TXTLCL';
			// $message = 'Welcome to Bank of Bangalore. Your account number is  '.$acc_no.' Consider using our 24x7 Internet banking services to get full advantage. Happy banking.' ;
