    ...
    <body>
       ...
       <h3>Internet Banking Registration</h3>
        ...
        <form method="post">
            ...
            <input type="text" name="dbtpin" placeholder="Debit Card Pin (xxxx)" required/>   
            <input type="text" name="mobile" placeholder="Registered Mobile (10 Digit)" maxlength=10 required />
            <input type="text" name="pan_no" placeholder="PAN NO(ABCDE1234F)" required />
            ...
            <input type="password" name="cnfrm_password" placeholder="Confirm Password" maxlength=4 required/>
